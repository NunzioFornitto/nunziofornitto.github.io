...
const i18n = {
  en: {
    ...
    'about-p3': 'I thrive in technically challenging environments where clean code, system design, and curiosity matter. Currently working as a <strong>DevOps Engineer</strong> at <strong>Reeturn S.r.l.s.</strong>, focusing on infrastructure automation and cloud-native technologies.',
  ...
  it: {
    ...
    'about-p3': 'Prospero in ambienti tecnicamente stimolanti dove contano codice pulito, design dei sistemi e curiosità. Attualmente lavoro come <strong>DevOps Engineer</strong> presso <strong>Reeturn S.r.l.s.</strong>, occupandomi di automazione infrastrutturale e tecnologie cloud-native.',
